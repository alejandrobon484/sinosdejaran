      ...
      {posts.map((post) => (
        ...
        >
          <div className="px-4 pt-4 sm:px-6">
            ...
            <FakeReviewCard reviewText={post.review_text} stars={5} />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 border-t border-zinc-100 px-4 py-3 sm:px-6">
